...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public static string product_AllSkins = "allskins";
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(product_AllSkins, ProductType.NonConsumable);
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, product_AllSkins, StringComparison.Ordinal))
        {
